...
export const MARKET_RULES = {
  US: {
    ...
    sourceLabel: "Amazon US 2026 费率更新",
    sourceUrl: "https://sellercentral.amazon.com/seller-forums/discussions/t/f3fa3211-820b-4e2e-a023-158a9cf55f99",
    feeSources: [
      ...
      { key: "storage", label: "基础仓储费", note: "月度仓储费率、季节与体积口径", url: "https://m.media-amazon.com/images/G/01/mcf-new-collection/SellerCentral/Amazon_MCF_Fulfillment_Storage_Fees_4_1_24.pdf" },
      { key: "aged", label: "长期仓储附加费", note: "181 天以上库存的收费区间与费率", url: "https://sellercentral.amazon.com/seller-forums/discussions/t/85f60e98-f93c-48fe-bee7-07917616f827" },
      { key: "liquidation", label: "清算费用", note: "清算回收范围、转介费与处理费口径", url: "https://sellercentral.amazon.com/seller-forums/discussions/t/da2955fb-cfc9-4b52-9f43-0adbf5f47a6d" },
      { key: "removal", label: "移除费", note: "按商品尺寸、重量计收的移除订单费", url: "https://sellercentral.amazon.com/gp/help/G200685050" },
    ],
    ageStart: 181,
    volumeUnit: "cuft",
    weightUnit: "lb",
  ...
  CA: {
    ...
    feeSources: [
      ...
      { key: "liquidation", label: "清算费用", note: "2026 年清算计划及相关收费说明", url: "https://sellercentral.amazon.ca/seller-forums/discussions/t/a9383e96-87ef-484e-bbe7-cc07584331bb" },
